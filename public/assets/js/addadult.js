(function ($) {
	...
	(function () {
		// const totalAdult = $("#input-guests-count-adults").val();
		// const totalChild = $("#input-guests-count-children").val();
		...
		function updateValues() {
			...
			$("#input-guests-count-adults").val(adultsCount);
            $("#input-guests-count-children").val(childrenCount);
